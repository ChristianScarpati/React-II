    ...
    return (
      ...
      <div id="main" className="container-fluid">
        ...
        <div className="col-xs-10">
         ...
         <Switch>
         <Route path="/albums/:id" render={({match}) => <SingleAlbum selectedSong={selectedSong} start={this.start} album={selectedAlbum} selectAlbum={this.selectAlbum} albumId={match.params.id}/>} />
